...
namespace WorkerApp
{
    public partial class Form : System.Windows.Forms.Form
    {
        ...
        public Form(AppDBContext context, IEmployeeService employeeService, IProjectService projectService)
        {
        ...
        private void InitializeUI()
        {
            ...
            {
                ShowErrorMessage("Error initializing UI", ex);
            }
        }
        ...
        private async void button1_Click(object sender, EventArgs e)
        {
            try
            {
                var calisanlar = await _employeeService.GetAllEmployeesAsync();
                dataGridView1.DataSource = calisanlar.ToList();
            }
            catch (Exception ex)
            {
                ShowErrorMessage("Error loading employees", ex);
            }
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            var projeCal�san = _context.ProjeCalisanlar.Find(projeler.ProjeNo);
            _context.ProjeCalisanlar.Remove(projeCal�san);
            _context.SaveChanges();
